...
- Name: home.spec.ts >> Hires homepage >> shows key CTA and footer links on the home page
- Location: tests\home.spec.ts:33:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4200/#/home
Call log:
  - navigating to "http://localhost:4200/#/home", waiting until "load"
