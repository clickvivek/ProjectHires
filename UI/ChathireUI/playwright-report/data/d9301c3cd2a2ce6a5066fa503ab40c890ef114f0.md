...
- Name: home.spec.ts >> Hires homepage >> search jobs form accepts a skill and location before submission
- Location: tests\home.spec.ts:102:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:4200/#/search-jobs
Call log:
  - navigating to "http://localhost:4200/#/search-jobs", waiting until "load"
